...
class PaymentController extends Controller
{
    ...
    public function show_payment_gateway_by_ajax($identifier)
    {
        ...
        if($page_data['payment_gateway']->identifier == "fawrypay"){
            ...
            $pay_url = $fawryPay->generatePayURL($uuid,$uuid,'http://success_url','http://failed_url');
            $pay_url = $fawryPay->generatePayURL($uuid,'Order 100001 Invoice','http://success_url','http://failed_url');
            PurchaseCourse::addPaymentData($identifier,$uuid);
