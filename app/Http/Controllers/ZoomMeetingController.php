...
class ZoomMeetingController extends Controller
{
    ...
    //     $clientId     = get_settings('zoom_client_id');
    //     $clientSecret = get_settings('zoom_client_secret');
    //     $oauthUrl     = 'https://zoom.us/oauth/token?grant_type=client_credentials';
    ...
    //         } else {
    //             error_log('OAuth Request Failed with Status Code: ' . $httpCode);
    //             error_log($response);
    //             return null;
    //         }
    //     } catch (Exception $e) {
    ...
    //     // dd($token); 
    //     if (!$token) {
    //         return json_encode(['error' => 'Failed to generate Zoom access token']);
    //     }
