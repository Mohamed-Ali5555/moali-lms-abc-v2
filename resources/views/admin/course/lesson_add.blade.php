...
<div class="lesson-wizard tf-modal-form">
    <div class="lesson-wizard__banner">
        ...
        <div class="lesson-wizard__type-pill">
            ...
            <a onclick="ajaxModal('{{ route('modal', ['admin.course.lesson_type', 'id' => $id]) }}', '{{ get_phrase('Add new lesson') }}', 'modal-lg')"
    ...
    <form class="ajaxFormSubmission" action="{{ route('admin.lesson.store') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="lesson-wizard__footer">
            <a href="javascript:void(0)"
                onclick="ajaxModal('{{ route('modal', ['admin.course.lesson_type', 'id' => $id]) }}', '{{ get_phrase('Add new lesson') }}', 'modal-lg')"
