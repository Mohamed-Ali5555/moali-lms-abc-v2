...
<div class="ol-header print-d-none d-flex align-items-center justify-content-between">
    <div class="header-title-menubar d-flex align-items-center flex-wrap">
        <div class="main-header-title d-flex align-items-center pb-sm-0 h-auto p-0">
            <button class="menu-toggler sidebar-plus" type="button" aria-label="{{ get_phrase('Toggle menu') }}">
            ...
            <h1 class="page-title ms-2 fs-18px d-flex flex-column row-gap-0">
                ...
                <p class="text-12px fw-500 d-none d-xl-inline-block mt-1">{{ get_phrase('Admin Panel') }}</p>
            </h1>
        </div>
        <a href="{{ route('home') }}" target="_blank" class="btn btn-sm p-0 ms-3 text-14px text-muted">
        ...
        <div class="d-none d-sm-block">
            <div class="img-text-select ">
                ...
                <div class="drop-content">
                    <ul>
                        @foreach (Cache::remember('languages.all', 3600, fn () => App\Models\Language::all()) as $lng)
                            <li>
