                                ...
                                <li>
                                    <div class="class-data">
                                        ...
                                        <div class="class-ststus">
                                            ...
                                            <small>
                                                ({{ \Carbon\Carbon::createFromTimestamp($class->start_time)->setTimezone('Africa/Cairo')->format('h:i a') }} - 
                                                {{ \Carbon\Carbon::createFromTimestamp($class->end_time)->setTimezone('Africa/Cairo')->format('h:i a') }})
                                            </small>
                                        </div>
                                    </div>
