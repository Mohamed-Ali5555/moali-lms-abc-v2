                ...
                <div class="ol-card-body mb-5 p-3">
                    <div class="row mb-4 mt-3">
                        <div class="col-md-6 d-flex align-items-center gap-3">
                            @if (has_permission('admin.bootcamp.export'))
                            ...
                            @endif
                            @if (has_permission('admin.bootcamp.filter'))
                        ...
                        @if (has_permission('admin.bootcamp.search'))
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="dAdmin_info_name min-w-150px">
                                                            ...
                                                            @else
                                                                <p>{{ currency($bootcamp->price - $bootcamp->discount_price) }}
                                                                </p>
                                                            @endif
                                                        </div>
                                                    </td>
                                                    <td class="print-d-none">
                                                        <div class="dropdown ol-icon-dropdown ol-icon-dropdown-transparent">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                ...
                                                                @if (has_permission('admin.bootcamp.status'))
                                                                    @if ($bootcamp->status)
                                                                        <li>
