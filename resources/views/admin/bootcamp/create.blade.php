            ...
            <div class="tf-hero">
                <div>
                    <div class="tf-hero__kicker">
                        ...
                        {{ get_phrase('Bootcamps') }}
                    </div>
                    <h1 class="tf-hero__title">{{ get_phrase('Add new Bootcamp') }}</h1>
                    <p class="tf-hero__desc">{{ get_phrase('Fill the essentials below. You can refine details after creating the bootcamp.') }}</p>
                </div>
            ...
            <div class="ol-card" style="border:none;box-shadow:none;background:transparent;">
                <form action="{{ route('admin.bootcamp.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="pt-2">
                            <button type="submit"
                                class="tf-btn tf-btn--primary float-end">{{ get_phrase('Submit') }}</button>
                        </div>
                    </div>
                </form>
            </div>
