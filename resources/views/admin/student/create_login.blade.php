<div class="row mb-3">
    ...
    <div class="col-sm-8">
        <input type="email" name="email" class="form-control ol-form-control" id="email" @isset($student->email) value="{{ old('email', isset($student) ? $student->email : '') }}"  @endisset required>
    </div>
</div>
