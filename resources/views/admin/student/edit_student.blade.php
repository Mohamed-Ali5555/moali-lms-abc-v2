...
@push('title', get_phrase('Edit Student'))
        ...
        <div class="tf-workspace tf-workspace--wide">
            <div class="tf-hero">
                <div>
                    ...
                    <h1 class="tf-hero__title">{{ get_phrase('Edit Student') }}</h1>
                    <p class="tf-hero__desc">{{ get_phrase('Update student profile and login credentials.') }}</p>
                </div>
                <div class="tf-hero__actions">
                    <a href="{{ route('admin.student.index') }}" class="tf-btn tf-btn--ghost">
