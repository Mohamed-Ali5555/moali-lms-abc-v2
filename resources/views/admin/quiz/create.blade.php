...
<div class="quiz-wizard lesson-wizard tf-modal-form">
    <div class="lesson-wizard__banner">
        ...
        <div class="lesson-wizard__course">
            ...
            <strong id="quizTypeBadge">{{ get_phrase('Quiz') }}</strong>
        </div>
    </div>

    <form action="{{ route('admin.course.quiz.store') }}" method="post">
        @csrf
        ...
        <div class="lesson-form-section">
            ...
            <div class="mb-3">
                ...
                <div class="tf-choice tf-choice--2">
                    <label for="quiz_type_1">
                        <input type="radio" name="type" id="quiz_type_1" value="1" checked
                            onchange="document.getElementById('quizTypeBadge').textContent = '{{ get_phrase('Quiz') }}'">
                    ...
                    <label for="quiz_type_2">
                        <input type="radio" name="type" id="quiz_type_2" value="2"
                            onchange="document.getElementById('quizTypeBadge').textContent = '{{ get_phrase('Assignment') }}'">
                        <span class="tf-choice__card">
                            <span>
            ...
            <div class="mb-0">
                ...
                <select class="form-control ol-form-control" id="section" name="section" required>
                    <option value="" disabled selected>{{ get_phrase('Select an option') }}</option>
