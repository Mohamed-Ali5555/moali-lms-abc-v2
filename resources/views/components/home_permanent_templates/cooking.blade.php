                ...
                <div class="col-md-12">
                    ...
                    <div class="cooking-counter-area d-flex">
                        <div class="cooking-counter-single">
                            <h2 class="total fw-500"><span class="counter1">{{ $total_students }}</span>+</h2>
                            <p class="info">{{ get_phrase('Enrolled Learners') }}</p>
                        </div>
                        <div class="cooking-counter-single">
                            <h2 class="total fw-500"><span class="counter1">{{ $total_instructors }}</span></h2>
                            <p class="info">{{ get_phrase('Online Instructors') }}</p>
                        </div>
                        <div class="cooking-counter-single">
                            <h2 class="total fw-500"><span class="counter1">{{ $premium_courses }}</span>+</h2>
                            <p class="info">{{ get_phrase('Premium courses') }}</p>
                        </div>
                        <div class="cooking-counter-single">
                            <h2 class="total fw-500"><span class="counter1">{{ $free_courses }}</span>+</h2>
