                ...
                <div class="row g-28px row-cols-xl-4 row-cols-lg-3 row-cols-md-2 row-cols-1">
                    <div class="col">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                <h2 class="kg-counter-title mb-2px"><span class="counter2">{{ $premium_courses }}</span>+</h2>
                    ...
                    <div class="col">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                <h2 class="kg-counter-title mb-2px"><span class="counter2">{{ $total_instructors }}</span>+</h2>
                    ...
                    <div class="col">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                <h2 class="kg-counter-title mb-2px"><span class="counter2">{{ $total_students }}</span>+</h2>
                    ...
                    <div class="col">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                <h2 class="kg-counter-title mb-2px"><span class="counter2">{{ $free_courses }}</span>+</h2>
