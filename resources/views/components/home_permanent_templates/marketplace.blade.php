            ...
            <div class="row mb-100px">
                <div class="col-md-12">
                    @php
                        ...
                        $free_courses = DB::table('courses')->where('is_paid', 0)->count();
                        $premium_courses = DB::table('courses')->where('is_paid', 1)->count();
                    @endphp
                    <div class="counter-area-wrap2">
                        <div class="counter-single-item2">
                            <h1 class="title-4 fs-82px lh-107px fw-semibold text-white text-center mb-5px"><span class="counter2">{{ $total_students }}</span>+</h1>
                            <p class="subtitle-3 fs-18px lh-25px fw-normal text-white text-center">{{ get_phrase('Happy Student') }}</p>
                        </div>
                        <div class="counter-single-item2">
                            <h1 class="title-4 fs-82px lh-107px fw-semibold text-white text-center mb-5px"><span class="counter2">{{ $total_instructors }}</span></h1>
                            <p class="subtitle-3 fs-18px lh-25px fw-normal text-white text-center">{{ get_phrase('Quality educators') }}+</p>
                        </div>
                        <div class="counter-single-item2">
                            <h1 class="title-4 fs-82px lh-107px fw-semibold text-white text-center mb-5px"><span class="counter2">{{ $premium_courses }}</span>+</h1>
                            <p class="subtitle-3 fs-18px lh-25px fw-normal text-white text-center">{{ get_phrase('Premium courses') }}</p>
                        </div>
                        <div class="counter-single-item2">
                            <h1 class="title-4 fs-82px lh-107px fw-semibold text-white text-center mb-5px"><span class="counter2">{{ $free_courses }}</span>+</h1>
            ...
            <div class="row mb-50px">
                <div class="col-md-12">
                    <div class="swiper lms-testimonial-2">
                        <div class="swiper-wrapper">
                            @php
                                $reviews = DB::table('user_reviews')->latest('id')->take(20)->get();
                            @endphp
