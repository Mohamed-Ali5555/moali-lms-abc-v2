    ...
    <div class="container">
        ...
        <span class="featured-course">
            ...
            <div class="row mt-50 gx-5">
                @foreach ($featured_courses as $key => $row)
                                    ...
                                    <div class="entry-details">
                                        ...
                                        <ul>
                                            <li>
                                                ...
                                                {{ $row->lessons_count }} {{ get_phrase('lesson') }}
                                            </li>
                                            <li>
                                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                                ...
                                                {{ $row->enrollments_count }} {{ get_phrase('Students') }}
                                            </li>
                                        </ul>
                                        <div class="creator mt-54">
                                            <img src="{{ course_instructor_image($row->id) }}" alt="...">
                                            <p>{{ get_phrase('by') }} <span>{{ $row->creator->name ?? course_by_instructor($row->id)->name }}</span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
