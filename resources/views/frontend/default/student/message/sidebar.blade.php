        ...
        <div class="message-left">
            <div class="contacts d-flex flex-column">
                ...
                @foreach ($my_threads as $thread)
                    ...
                    <a href="{{ route('message', ['inbox' => $thread->code, 'instructor' => $thread->user->id]) }}" class="contact border-end mb-3 @if ($thread->code == request()->query('inbox')) active @endif">
                        <div class="ins-nav">
                            ...
                            <div class="ins-left align-items-start">
                                ...
                                <div class="ins-figure">
                                    ...
                                    <small>{{ timeAgo($last_message->created_at) }}</small>
                                </div>
                            </div>
