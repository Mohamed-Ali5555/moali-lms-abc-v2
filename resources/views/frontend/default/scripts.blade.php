<script>
    ...
    $(function() {
        if ($('.tagify:not(.inited)').length) {
            var tagifyCss = '{{ asset('assets/global/tagify-master/dist/tagify.css') }}';
            var tagifyJs = '{{ asset('assets/global/tagify-master/dist/tagify.min.js') }}';
            var boot = function() {
            ...
            if (typeof Tagify === 'undefined') {
                if (!document.querySelector('link[href="' + tagifyCss + '"]')) {
