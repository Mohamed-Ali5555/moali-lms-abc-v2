...
@section('content')
    @php
        $instructor_review = App\Models\Instructor_review::where(
            'instructor_id',
            get_course_creator_id($course_details->id)->id,
        )
            ->orderBy('id', 'DESC')
            ->get();
                    ...
                    <div class="eNtry-breadcum mt-4">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb d-flex flex-nowrap">
                                ...
                                <li class="breadcrumb-item ellipsis-line-1 active" aria-current="page">
                        ...
                        <div class="row row-gap-4">
                            ...
                            <div class="col-6 col-sm-6 col-md-4 text-dark">
                                <p class="d-flex align-items-center">
                                    @if ($total > 0)
                                        <span
                                            class="d-inline-block mx-2">{{ number_format(round($average_rating), 1) }}</span>
                            ...
                            <div class="col-6 col-sm-6 col-md-4 d-flex align-items-center text-dark">
                                <img class="pro-20 me-2" src="{{ asset('assets/frontend/default/image/language.png') }}"
                                    alt="...">
                                {{ ucfirst($course_details->language) }}
                            </div>
                            <div class="col-6 col-sm-6 col-md-4 d-flex align-items-center text-dark">
                                <img class="pro-20 me-2" src="{{ asset('assets/frontend/default/image/g3.png') }}"
                                    alt="...">
                                {{ get_phrase('Certificate Course') }}
                            </div>
                            <div class="col-6 col-sm-6 col-md-4 d-flex align-items-center text-dark">
                                <img class="pro-20 me-2" src="{{ asset('assets/frontend/default/image/g2.png') }}"
                                    alt="...">
                                {{ total_enroll($course_details->id) }} {{ get_phrase('Students') }}
                            </div>
                            <div class="col-6 col-sm-6 col-md-4 d-flex align-items-center text-dark">
                                <img class="pro-20 me-2" src="{{ asset('assets/frontend/default/image/g1.png') }}"
                                    alt="...">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 order-2 order-lg-1">
                    ...
                    <div class="ps-box static-menu mt-5 w-100">@include('frontend.default.course.overview_area')</div>
                    <div class="ps-box static-menu mt-5 w-100">@include('frontend.default.course.content_area')</div>
    ...
    <div class="modal fade-in-effect" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
            ...
            <div class="modal-content">
                <div class="modal-body bg-dark">
                    ...
                    @php
                        ...
                        $preview_video_type =
                            str_contains($course_details->preview, 'vimeo') && $preview_video_type == ''
                                ? 'vimeo'
                                : $preview_video_type;
                        $preview_video_type =
                            str_contains($course_details->preview, 'http') && $preview_video_type == ''
                                ? 'html5'
                                : $preview_video_type;
                    @endphp
                    ...
                    @if ($preview_video_type == 'youtube')
                        <div class="plyr__video-embed" id="promoPlayer">
                            <iframe height="500"
                                src="{{ $course_details->preview }}?origin=https://plyr.io&amp;iv_load_policy=3&amp;modestbranding=1&amp;playsinline=1&amp;showinfo=0&amp;rel=0&amp;enablejsapi=1"
                                allowfullscreen allowtransparency allow="autoplay"></iframe>
                        </div>
                    @elseif ($preview_video_type == 'vimeo')
                        <div class="plyr__video-embed" id="promoPlayer">
                            <iframe height="500" id="promoPlayer"
                                src="https://player.vimeo.com/video/{{ $course_details->preview }}?loop=false&amp;byline=false&amp;portrait=false&amp;title=false&amp;speed=true&amp;transparent=0&amp;gesture=media"
                                allowfullscreen allowtransparency allow="autoplay"></iframe>
                        </div>
