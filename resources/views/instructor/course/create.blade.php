                            ...
                            <div class="col-md-6 pb-2">
                                <div class="eForm-layouts">
                                    <div class="fpb-7 mb-3">
                                        ...
                                        <input type="text" name = "title" value="{{old('title')}}" class="form-control ol-form-control" placeholder="{{ get_phrase('Enter Course Title') }}" required>
                                    </div>
                                    <div class="fpb-7 mb-3">
                                        <label class="form-label ol-form-label" for="short_description">{{ get_phrase('Short Description') }}</label>
                                        <textarea name="short_description" value="{{old('short_description')}}"  placeholder="{{ get_phrase('Enter Short Description') }}" class="form-control ol-form-control" rows="5">{{old('short_description')}}</textarea>
                                    </div>
                                    <div class="fpb-7 mb-3">
                                        <label class="form-label ol-form-label" for="description">{{ get_phrase('Description') }}</label>
                                        <textarea name="description" value="{{old('description')}}" placeholder="{{ get_phrase('Enter Description') }}" class="form-control ol-form-control text_editor">{{old('description')}}</textarea>
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="eForm-layouts">
                                        ...
                                        <div class="eRadios">
                                            ...
                                            <div class="paid-section" id="paid-section">
                                                <div class="fpb-7 mb-3">
                                                    ...
                                                    <input type="number" name="price" value="{{old('price')}}"  class="form-control ol-form-control" id="price" min="1" step=".01" placeholder="{{ get_phrase('Enter your course price') }} ({{ currency() }})">
                                                </div>

                                                <div class="fpb-7 mb-3">
                                                    <div class="form-check">
                                                        <input type="checkbox" name="discount_flag" value="1" {{ old('discount_flag', '1') == '1' ? 'checked' : '' }}  class="form-check-input eRadioSuccess" id="discount_flag">
                                                        <label for="discount_flag" class="form-check-label">{{ get_phrase('Check if this course has discount') }}</label>
                                                    </div>
                                                </div>

                                                <div class="fpb-7 mb-3">
                                                    <label for="discount_price" class="form-label ol-form-label">{{ get_phrase('Discounted price') }}</label>

                                                    <input type="number" name="discount_price" value="{{old('discount_price')}}" class="form-control ol-form-control" id="discount_price" min="1" step=".01" placeholder="{{ get_phrase('Enter your discount price') }} ({{ currency() }})">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="fpb-7 mb-3 ">
                                        ...
                                        <div class="eRadios">
                                            <div class="form-check">
                                                <input type="radio" value="0" {{ old('enable_drip_content', '0') == '0' ? 'checked' : '' }} name="enable_drip_content" class="form-check-input eRadioSuccess" id="drip_off" required checked>
                                                <label for="drip_off" class="form-check-label">{{ get_phrase('Off') }}</label>
                                            </div>

                                            <div class="form-check">
                                                <input type="radio" value="1" {{ old('enable_drip_content', '1') == '1' ? 'checked' : '' }} name="enable_drip_content" class="form-check-input eRadioPrimary" id="drip_on" required>
