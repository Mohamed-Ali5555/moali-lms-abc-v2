                                                ...
                                                <tr>
                                                            ...
                                                            <div class="dAdmin_profile_name">
                                                                ...
                                                                <a href="{{ route('instructor.courses', ['instructor' => $row->user_id]) }}">
                                                                    <p class="sub-title2 text-12px">
                                                                        ...
                                                                        {{ $row->creator->name ?? get_user_info($row->user_id)->name }}</p>
                                                                    <p class="sub-title2 text-12px">{{ get_phrase('Email') }}:
                                                                        {{ $row->creator->email ?? get_user_info($row->user_id)->email }}</p>
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="sub-title2 text-12px">
                                                            <a href="{{ route('instructor.courses', ['category' => $row->category->slug ?? '']) }}">{{ $row->category->title ?? category_by_course($row->category_id)->title }}</a>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="sub-title2 text-12px">
                                                            <a href="{{ route('instructor.course.edit', [$row->id, 'tab' => 'curriculum']) }}">
                                                                <p>{{ get_phrase('Lesson') }}: {{ $row->lessons_count ?? lesson_count($row->id) }} </p>
                                                                <p> {{ get_phrase('Section') }}: {{ $row->sections_count ?? section_count($row->id) }} </p>
                                                            </a>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="sub-title2 text-12px">
                                                            <p>{{ get_phrase('Enrollment History') }}:
                                                                {{ $row->enrollments_count ?? course_enrollments($row->id) }}
                                                            </p>
                                                        </div>
                                                    </td>
