...
<div class="paid-section @if ($course_details->is_paid != 1) d-hidden @endif" id="paid-section">
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-10">
            <input type="number" name="discount_price" value="{{ $course_details->discount_price }}" class="form-control ol-form-control" id="discount_price" min="1" step=".01" placeholder="{{ get_phrase('Enter your discount price') }} ({{ currency() }})">
        </div>
    </div>
</div>
