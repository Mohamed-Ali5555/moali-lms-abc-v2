...
<div class="paid-section @if($bootcamp_details->is_paid != 1) d-hidden @endif" id="paid-section">
	<div class="row mb-3">
		...
		<div class="col-sm-10">
			<input type="number" name="price" value="{{$bootcamp_details->price}}" class="form-control ol-form-control" id="price" min="1" step=".01" placeholder="{{get_phrase('Enter your course price')}} ({{currency()}})">
		</div>
	</div>
