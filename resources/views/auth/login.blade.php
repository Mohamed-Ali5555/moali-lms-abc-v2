                    ...
                    <div class="col-lg-5 col-md-6">
                        <form action="{{ route('login') }}" class="global-form login-form mt-25" id="login-form" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="email" name="email" value="{{old('email')}}"class="form-control" placeholder="{{ get_phrase('Your Email') }}">
                            </div>
                            <div class="form-group">
                                <label for="" class="form-label">{{ get_phrase('Password') }}</label>
                                <input type="password" id="password"  value="{{old('password')}}" name="password" class="form-control" placeholder="*********">
                            </div>
