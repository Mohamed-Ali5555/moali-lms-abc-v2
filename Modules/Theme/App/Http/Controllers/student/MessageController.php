...
class MessageController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('theme::student.message.index',$page_data);
    }
    ...
    public function fetch_message(Request $request)
    {
        ...
        return view('theme::student.message.body', compact('conversations'));
    ...
    public function search_student(Request $request)
    {
        ...
        return view('theme::student.message.search_result',$page_data);
