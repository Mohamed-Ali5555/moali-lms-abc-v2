...
class TutorBookingController extends Controller
{
    public function my_bookings()
    {
        ...
        return view('theme::student.my_bookings.index',$page_data);
    ...
    public function booking_invoice($id = "")
    {
        ...
        return view('theme::student.my_bookings.invoice',$page_data);
    ...
    public function join_class($booking_id = "")
    {
        ...
        if (get_settings('zoom_web_sdk') == 'active') {
            ...
            return view('theme::student.my_bookings.join_tution',$page_data);
