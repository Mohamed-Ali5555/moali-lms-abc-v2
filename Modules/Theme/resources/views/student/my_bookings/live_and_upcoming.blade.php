            ...
            <tbody>
                @foreach ($my_bookings as $my_booking)
                    <tr>
                        ...
                        <td>
                            <a href="{{ tution_started($my_booking->id) ? route('theme.tution_class.join', slugify($my_booking->id)) : 'javascript:void(0);' }}"
                        ...
                        <td>
                            <a href="{{ route('theme.booking_invoice', $my_booking->id) }}"
