                    ...
                    <div class="my-panel purchase-history-panel">
                        ...
                        <ul class="nav nav-pills mb-3 gap-4" id="pills-tab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a href="{{ route('theme.my_bookings', ['tab' => 'live-upcoming']) }}" class="nav-link gradient-border-btn {{ request('tab') === 'live-upcoming' ? 'active' : '' }}">
                                    Live & Upcoming
                                </a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a href="{{ route('theme.my_bookings', ['tab' => 'archive']) }}" class="nav-link gradient-border-btn {{ request('tab') === 'archive' ? 'active' : '' }}">
                                    Archive
                                </a>
                            </li>
                        </ul>
