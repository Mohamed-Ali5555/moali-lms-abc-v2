                    ...
                    @foreach ($members as $member)
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="javascript:void(0)" onclick="confirmModal('{{ route('theme.my.team.packages.members.action', ['remove', 'package_id' => $package->id, 'user_id' => $member->member_id]) }}')" class="btn btn-primary text-18 d-inline-flex p-3 text-white">
        ...
        $(document).ready(function() {
            ...
            searchInput.keyup(function(e) {
                ...
                if (inputValue.includes('@')) {
                    $.ajax({
                        type: "get",
                        url: "{{ route('theme.search.package.members') }}/" + "{{ $package->id }}",
                        data: {
                            email: inputValue
                        },
