            ...
            <tbody>
                @foreach ($purchased_packages as $key => $purchased_package)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('theme.team.package.invoice', $purchased_package->id) }}" class="d-flex align-items-center justify-content-center btn btn-primary text-18 py-3 text-white">
