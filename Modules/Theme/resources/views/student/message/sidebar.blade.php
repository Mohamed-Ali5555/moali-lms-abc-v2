        ...
        <div class="message-left">
            <div class="contacts d-flex flex-column">
                ...
                @foreach ($my_threads as $thread)
                    ...
                    <a href="{{ route('theme.message', ['inbox' => $thread->code, 'instructor' => $thread->user->id]) }}" class="contact border-start mb-3 @if ($thread->code == request()->query('inbox')) active @endif">
                        <div class="ins-nav">
