            ...
            <div class="table-responsive">
                <table class="table eTable eTable-2">
                    <tbody>
                        ...
                        @if(collect($payment_details['items'])->where('type', 'course')->count() > 0)
                            @foreach ($payment_details['items'] as $key => $item)
                                @if ($item['type'] == 'course')
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="dAdmin_info_name text-center">
                                                <p>1</p>
                                            </div>
                                        </td>
                                        <td>
                        ...
                        @if(collect($payment_details['items'])->where('type', 'book')->count() > 0)
                            @foreach ($payment_details['items'] as $key => $item)
                               @if ($item['type'] == 'book')
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <div class="dAdmin_info_name min-w-150px text-end">
                                                    <p>{{ currency($item['price'] * $item['qty'], 2) }} </p>
                                            </div>
                                        </td>
                                    </tr>
                                @endif
