    ...
    <div class="ql-panel" dir="rtl">
        <div class="ql-toolbar">
            ...
            <div class="ql-toolbar__actions">
                <a href="#"
                    onclick="ajaxModal('{{ route('modal', ['bankquestions::questions.create', 'id' => $id, 'category_id' => $quiz->category_id]) }}', '{{ get_phrase('إضافة سؤال') }}', 'modal-xl')"
                    class="ql-btn ql-btn--primary">
                    <i class="fi-rr-add"></i> {{ get_phrase('إضافة سؤال') }}
                </a>
                <a href="#"
                    onclick="ajaxModal('{{ route('modal', ['bankquestions::questions.choose', 'id' => $id]) }}', '{{ get_phrase('اختيار سؤال') }}', 'modal-xl')"
                    class="ql-btn">
                    <i class="fi-rr-list"></i> {{ get_phrase('اختيار سؤال') }}
                </a>
                <a href="#"
                    onclick="ajaxModal('{{ route('modal', ['bankquestions::questions.sort', 'id' => $id]) }}', '{{ get_phrase('ترتيب الأسئلة') }}', 'modal-lg')"
                    class="ql-btn">
                    <i class="fi-rr-drag"></i> {{ get_phrase('ترتيب الأسئلة') }}
                </a>
            </div>
        </div>
            ...
            @foreach ($questions as $question)
                ...
                <li class="ql-item">
                    ...
                    <div class="ql-item__actions">
                        <a href="#"
                            onclick="ajaxModal('{{ route('modal', ['bankquestions::questions.edit', 'id' => $question->id]) }}', '{{ get_phrase('تعديل سؤال') }}', 'modal-xl')"
...
@else
    <div class="ql-empty" dir="rtl">
        <a onclick="ajaxModal('{{ route('modal', ['bankquestions::questions.create', 'id' => $id, 'category_id' => $quiz->category_id]) }}', '{{ get_phrase('إضافة سؤال') }}', 'modal-xl')"
            href="#" class="ql-empty__card">
            <i class="fi-rr-add"></i>
            <span>{{ get_phrase('إضافة سؤال') }}</span>
        </a>
        <a onclick="ajaxModal('{{ route('modal', ['bankquestions::questions.choose', 'id' => $id, 'category_id' => $quiz->category_id]) }}', '{{ get_phrase('اختيار سؤال') }}', 'modal-xl')"
            href="#" class="ql-empty__card">
